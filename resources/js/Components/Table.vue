<template>
    ...
    <div v-else class="flex flex-col gap-4 items-center">
        <button @click.prevent="$emit('onCreate')" class="p-2 bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 focus:outline-0 rounded"><i class="fas fa-plus mr-2"></i>New Record</button>
        <Alert>
